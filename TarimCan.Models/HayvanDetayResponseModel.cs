...
namespace TarimCan.Models
{
    public class HayvanDetayResponseModel
    {
        ...
        public List<DurumHareketModel> DurumHareketleriReverse { get; set; }
    ...
    public class DurumHareketModel
    {
        ...
        public string Icon
        {
            get
            {
                if(DurumBilgisiId == 1 || DurumBilgisiId == 2 || DurumBilgisiId == 3 || DurumBilgisiId == 4 || DurumBilgisiId == 6 || DurumBilgisiId == 8 || DurumBilgisiId == 20)
                {
                    return DurumBilgisiId.ToString() + ".png";
                }
                else
                {
                    return "bos.png";
