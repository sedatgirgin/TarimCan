...
namespace TarimCan.Models
{
    public class HayvanModel
    {
        ...
        public bool EsiniSonunuAttiMi { get; set; }
        public double TohumTutmaOrani { get; set; }
        public double ServisPeriyodu { get; set; }
        public double InekGebeKalmaOrani { get; set; }
        public double DuveGebeKalmaOrani { get; set; }
    }
}