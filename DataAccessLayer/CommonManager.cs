...
namespace Tarimcan.DataAccessLayer
{
    public class CommonManager
    {
        ...
        public DBCheckModel KullaniciPadokKaydet(PadokModel model)
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        public DBCheckModel KullaniciPadokSil(int PadokId)
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        public List<SelectListItem> DemirbasTipleriGetir(int ModulId)
        {
            List<SelectListItem> items = new List<SelectListItem>();
        ...
        public DBCheckModel IsletmeDemirbasTipiKaydet(string Value)
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        public DBCheckModel IsletmeDemirbasYeriKaydet(string Value)
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pTCKimlikNo", TCKimlikNo));
