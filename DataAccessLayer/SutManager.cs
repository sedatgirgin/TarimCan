...
namespace TarimCan.DataAccessLayer
{
    public class SutManager
    {
        ...
        public List<SutModel> GunlukSutSatisOzetiGetir()
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        public List<SutModel> GunlukSagilanHayvanlariGetir(DateTime IslemTarihi)
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
            lstParam.Add(new SqlParameter("@pIsletmeId", IsletmeId));
        ...
        public List<SutModel> SagmalHayvanlariGetir()
        {
            List<SqlParameter> lstParam = new List<SqlParameter>();
        ...
        public decimal SonSutLitreFiyatiGetir()
        {
            decimal sonuc = 0;
