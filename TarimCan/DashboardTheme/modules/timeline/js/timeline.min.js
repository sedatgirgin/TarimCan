...
function timeline(e, v) {
    ...
    function l(e, t) {
        ...
        return (
            ...
            i.top <= r && i.left <= (window.innerWidth || document.documentElement.clientWidth) && 0 <= i.top + i.height && 0 <= i.left + i.width
        );
    }
    function d(e, t) {
        ...
        [].forEach.call(e, function (e) {
            ...
            Object.keys(b).forEach(function (e) {
                ...
                (r[e] = b[e].defaultValue),
                    ...
                    "integer" === b[e].type
                        ...
                        (console.warn(p + ' The value "' + r[e] + '" entered for the setting "' + e + '" was not recognised.'), (r[e] = b[e].defaultValue));
            });
            ...
            if (
                (m || (console.warn(p + " No numercial value entered for the 'verticalTrigger' setting."), (f = !1)),
                    ...
                    "%" === u && (100 < m || m < 0)
                        ? (console.warn(p + " The 'verticalTrigger' setting value must be between 0 and 100 if using a percentage value."), (f = !1))
                        : "px" === u && m < 0 && (console.warn(p + " The 'verticalTrigger' setting value must be above 0 if using a pixel value."), (f = !1)),
                    !1 === f)
            ) {
            ...
            (r.verticalTrigger = { unit: u, value: m }),
                ...
                (console.warn(p + ' The value of "moveItems" (' + r.moveItems + ') is larger than the number of "visibleItems" (' + r.visibleItems + '). The value of "visibleItems" has been used instead.'),
                    (r.moveItems = r.visibleItems)),
                r.startIndex > a.length - r.visibleItems && a.length > r.visibleItems
                    ? (console.warn(p + " The 'startIndex' setting must be between 0 and " + (a.length - r.visibleItems) + " for this timeline. The value of " + (a.length - r.visibleItems) + " has been used instead."),
